                          ...
                          <div key={lesson.id} className="flex items-center justify-between gap-3 rounded-xl border border-slate-200 bg-white px-3 py-2">
                            ...
                            <div className="flex shrink-0 items-center gap-2">
                              ...
                              <button
                                ...
                                className="rounded-lg border border-slate-200 px-2.5 py-1 text-xs font-bold text-slate-700 transition hover:border-sky-300 hover:bg-sky-50"
                              >
                                Practicar
                              </button>
                            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              ...
              {gradeSummary.nextLesson && (
                <button
                  type="button"
                  onClick={() => openLesson(gradeSummary.nextLesson)}
                  className="mt-4 rounded-xl bg-sky-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-sky-700"
                >
                  Practicar ahora
                </button>
              )}
