...
import { attachRoleContext, requireAuth, resolveEffectiveRole } from '../middlewares/authMiddleware.js'
...
router.post('/sync', requireAuth, async (req, res) => {
  try {
    ...
    const role = resolveEffectiveRole(req.user, existingUser)
...
router.get('/profile', requireAuth, attachRoleContext, async (req, res) => {
  try {
    const { id } = req.user
